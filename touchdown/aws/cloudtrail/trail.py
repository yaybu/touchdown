...
class Trail(Resource):
    ...
    cwlogs_group = argument.Resource(
        LogGroup,
        field="CloudWatchLogsLogGroupArn",
        serializer=serializers.Property("arn"),
    )
    cwlogs_role = argument.Resource(
        Role, field="CloudWatchLogsRoleArn", serializer=serializers.Property("Arn")
    )
...
class Describe(SimpleDescribe, Plan):
    ...
    def get_describe_filters(self):
        return {"trailNameList": [self.resource.name]}
...
class Destroy(SimpleDestroy, Describe):
    ...
    def get_destroy_serializer(self):
        return serializers.Dict(Name=self.resource.name)
