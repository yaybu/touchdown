...
class Endpoint(Resource):
    ...
    service = argument.String(field="ServiceName", choices=["s3"])
...
class NameAction(Action):
    ...
    def run(self):
        self.runner.get_service(self.resource.id, "set").execute(self.plan.resource_id)
...
class Describe(SimpleDescribe, Plan):
    ...
    def get_describe_filters(self):
        ...
        return {"Filters": [{"Name": "vpc-endpoint-id", "Values": [vpce_id]}]}
