...
class TestCloudFront(aws.TestBasicUsage):
    ...
    def test_no_change(self):
        ...
        self.responses.add_fixture(
            "GET",
            "https://cloudfront.amazonaws.com/2016-01-13/distribution/EDFDVBD6EXAMPLE",
    ...
    def test_create(self):
        self.responses.add_fixture("GET", "https://cloudfront.amazonaws.com/2016-01-13/distribution", self.fixture_404, expires=1)
        self.responses.add_fixture("POST", self.base_url, self.fixture_create, expires=1)
        self.responses.add_fixture("GET", "https://cloudfront.amazonaws.com/2016-01-13/distribution", self.fixture_found)
        self.responses.add_fixture("GET", "https://cloudfront.amazonaws.com/2016-01-13/distribution/EDFDVBD6EXAMPLE", "aws_distribution_get")
        self.goal.execute()
        self.assertEqual(self.plan.resource_id, self.expected_resource_id)
