...
class TestWafIpSet(StubberTestCase):
    def test_annotate_ip_set(self):
        ...
        with stub:
            obj = describe.annotate_object({"IPSetId": "my-ip-set-id"})
    ...
    def test_create_ip_set(self):
        ...
        stub.add_response(
            "create_ip_set",
            expected_params={"ChangeToken": "mychangetoken1", "Name": "my-ip-set"},
            service_response={"ChangeToken": "mychangetoken1"},
        )
    ...
    def test_update_ip_set_with_descriptors(self):
        ...
        ip_set = self.aws.add_ip_set(name="my-ip-set", addresses=["10.0.0.1/32"])
        ...
        stub.add_response(
            ...
            expected_params={
                ...
                "Updates": [
                    {
                        "Action": "INSERT",
                        "IPSetDescriptor": {"Type": "IPV4", "Value": "10.0.0.1/32"},
                    }
                ],
                "IPSetId": "my-ip-set-id",
            },
