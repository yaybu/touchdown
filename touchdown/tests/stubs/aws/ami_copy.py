...
class ImageCopyStubber(ServiceStubber):
    ...
    def add_describe_images_empty_response(self):
        return self.add_response(
            ...
            expected_params={
                "Filters": [{"Name": "name", "Values": [self.resource.name]}]
            },
        )
    ...
    def add_copy_image(self):
        return self.add_response(
            "copy_image",
            service_response={"ImageId": self.make_id(self.resource.name)},
            expected_params={
                "Name": self.resource.name,
    ...
    def add_deregister_image(self):
        return self.add_response(
            "deregister_image",
            service_response={},
            expected_params={"ImageId": self.make_id(self.resource.name)},
        )
