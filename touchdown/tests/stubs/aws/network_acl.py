...
class NetworkAclStubber(ServiceStubber):
    ...
    def add_describe_network_acls_empty_response_by_name(self):
        return self.add_response(
            ...
            service_response={"NetworkAcls": []},
            expected_params={
                "Filters": [{"Name": "vpc-id", "Values": ["vpc-f96b65a5"]}]
            },
        )
                ...
                "NetworkAcls": [
                    {
                        ...
                        "Tags": [{"Key": "Name", "Value": self.resource.name + ".1"}],
                        "Entries": [],
                        "Associations": [],
                        "IsDefault": False,
                    }
    ...
    def add_create_network_acl(self):
        return self.add_response(
            "create_network_acl",
            service_response={
                "NetworkAcl": {"NetworkAclId": self.make_id(self.resource.name)}
            },
            expected_params={"VpcId": "vpc-f96b65a5"},
        )
    ...
    def add_delete_network_acl(self):
        return self.add_response(
            "delete_network_acl",
            service_response={},
            expected_params={"NetworkAclId": self.make_id(self.resource.name)},
        )
