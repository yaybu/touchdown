...
class AutoScalingGroupStubber(ServiceStubber):
    ...
    def add_describe_auto_scaling_groups_empty_response(self):
        return self.add_response(
            ...
            expected_params={"AutoScalingGroupNames": [self.resource.name]},
        )

    def add_describe_auto_scaling_groups_one_response(
        self, min_size=0, max_size=0, instances=None
    ):
        return self.add_response(
            "describe_auto_scaling_groups",
            service_response={
    ...
    def add_describe_scaling_activities(self, status_code="Successful"):
        return self.add_response(
            ...
            expected_params={"AutoScalingGroupName": self.resource.name},
        )
    ...
    def add_update_auto_scaling_group(self, desired=None, min=None, max=None):
        params = {"AutoScalingGroupName": self.resource.name}
        ...
        if max is not None:
            params["MaxSize"] = max
        return self.add_response(
            "update_auto_scaling_group", service_response={}, expected_params=params
        )
